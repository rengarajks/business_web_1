...
<div className='w-2/3'>
 ...
 <button className='bg-green-800 w-full mt-4 p-1 py-2 rounded-md'>Login</button>
 
 <div className='text-center mt-4'><span className='text-center'>Don't have an account? </span>

<Link to={'/signin'}><span className='text-green-600 '>Register here</span></Link></div>
